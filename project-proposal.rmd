...
How will you be reading in your data:
   The source does provide an API to use the data, thus we will be using the API. The downloadable files are also available, giving us an alternate option, if API does incur any problem.  

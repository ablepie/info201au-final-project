...
The source does provide an API to use the data, thus we will be using the API. The downloadable files are also available thus giving
us a alternate option, if API does incur any problem.  
